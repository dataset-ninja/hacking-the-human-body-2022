...
##################################
PROJECT_NAME: str = "Hacking the Human Body 2022"
PROJECT_NAME_FULL: str = "Hacking the Human Body 2022"
...
APPLICATIONS: List[Union[Industry, Domain, Research]] = [Research.Biological(),Industry.Medical(is_used=False)]
...
HOMEPAGE_URL: str = "https://www.kaggle.com/competitions/hubmap-organ-segmentation/data"
# e.g. "https://some.com/dataset/homepage"

PREVIEW_IMAGE_ID: int = 5006019
# This should be filled AFTER uploading images to instance, just ID of any image.

GITHUB_URL: str = "https://github.com/dataset-ninja/hacking-the-human-body-2022"
# URL to GitHub repo on dataset ninja (e.g. "https://github.com/dataset-ninja/some-dataset")

##################################
### * Optional after uploading ###
##################################
DOWNLOAD_ORIGINAL_URL: Optional[Union[str, dict]] = ["https://github.com/dataset-ninja/hacking-the-human-body-2022"]
...
AUTHORS_CONTACTS: Optional[List[str]] = ["https://hubmapconsortium.org/contact-form/"]
